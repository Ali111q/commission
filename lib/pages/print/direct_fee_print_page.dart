...
import 'package:Trip/data/model/direct_violations.dart';
...
class DirectFeePrintPage extends StatefulWidget {
  final DirectViolation feeModel;

  const DirectFeePrintPage({super.key, required this.feeModel});
  @override
  _MaterialUiPrinterDemoState createState() => _MaterialUiPrinterDemoState();
}

class _MaterialUiPrinterDemoState extends State<DirectFeePrintPage> {
  ...
  Widget _buildPaymentDetails() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          _buildInvoiceRow('مدفوعة', feeModel.isPaid ?? false ? "نعم" : "لا"),
          _buildInvoiceRow(
