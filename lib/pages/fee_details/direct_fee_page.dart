...
import 'package:Trip/pages/print/direct_fee_print_page.dart';
...
class DirectFeePage extends StatefulWidget {
  DirectFeePage({super.key});

  @override
  State<DirectFeePage> createState() => _FeeDetailsPageState();
}

class _FeeDetailsPageState extends State<DirectFeePage> {
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => controller.directViolationModel.value == null || loading
          ? CustomScaffold(
              body: Center(
                          ...
                          children: [
                                  ...
                                  mainImagePath:
                                      "https://garagat-api.digital-logic.tech/" +
                                          (controller.addFeesFormModel?.images
                                                  ...
                                                  false
                                              ? controller
                                                  .addFeesFormModel?.images[0]
                                              : controller.directViolationModel
                                                      .value!.images.isNotEmpty
                                                  ? controller
                                                      .directViolationModel
                                                      .value!
                                                      .images[0]
                                                  : ""),
                                  imagePaths: controller
                                          .addFeesFormModel?.images
                                          .map((e) =>
                                              "https://garagat-api.digital-logic.tech/" +
                                              e)
                                          .toList() ??
                                      controller
                                          .directViolationModel.value!.images
                                          .map((e) =>
                                              "https://garagat-api.digital-logic.tech/" +
                                              e)
                                          .toList(),
                                ...
                                children: [
                                  DetailsWidget1(
                                    ...
                                    value: controller.addFeesFormModel?.number
                                            .toString() ??
                                        controller
                                            .directViolationModel.value!.number
                                            .toString(),
                                  ),
                                  DetailsWidget1(
                            ...
                            Row(
                              children: [
                                DetailsWidget2(
                                  name: "رقم اللوحة",
                                  value: controller.directViolationModel.value!
                                          .plateNumber ??
                                      "لا يوجد",
                                ),
                                DetailsWidget2(
                                  name: "المحافظة",
                                  value:
                                      controller.directViolationModel.value !=
                                              null
                                          ? controller.directViolationModel
                            ...
                            Row(
                              children: [
                                DetailsWidget2(
                                  name: "اسم الكراج",
                                  value: prefs.getString("garageName") ??
                                      "لا يوجد",
                                ),
                                DetailsWidget2(
                                  name: "كراج الدفع",
              ...
              bottomNavigationBar: Container(
                ...
                child: CustomFillButton(
                  ...
                  onTap: () async {
                    ...
                    // testPrinter();
                    Get.to(DirectFeePrintPage(
                      feeModel: controller.directViolationModel.value!,
                    ));
                  },
                ),
              ),
